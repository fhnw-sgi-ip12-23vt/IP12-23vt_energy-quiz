...
_<Schnittstelle(n)>_
Die Anweisungen werden weiter an die Game Logik gesendet. Die genauere Schnittstelle zur Game Logik kann https://gitlab.fhnw.ch/ip12-23vt/energiequiz/docu/-/blob/main/software(sad)/EnergieQuizSAD.adoc#user-content-blackbox-game-controller[hier] gefunden werden.
...
_<Schnittstelle(n)>_
Dieses Subsystem erhaltet den aktuellen Spielstatus aus dem Susbsystem der Game Logik und zeigt diesen entsprechend an. Eine genauere Darstellung der Schnittstelle kann https://gitlab.fhnw.ch/ip12-23vt/energiequiz/docu/-/blob/main/software(sad)/EnergieQuizSAD.adoc#user-content-blackbox-game-controller[hier] aufgefunden werden
...
Es gibt mehre Schnittstellen zu den Game Models, welche https://gitlab.fhnw.ch/ip12-23vt/energiequiz/docu/-/blob/main/software(sad)/EnergieQuizSAD.adoc#user-content-ebene-3[hier] auf Ebene 3 genauer aufgezeigt werden.
...
_<Schnittstelle(n)>_
Die verschiedenen Objekte werden vom Game-Controller verwendet um den aktuellen Spielstand darzustellen. Die genauere Darstellung der Schnittstellen wird https://gitlab.fhnw.ch/ip12-23vt/energiequiz/docu/-/blob/main/software(sad)/EnergieQuizSAD.adoc#user-content-ebene-3[hier], auf Ebene 3, aufgezeigt.
