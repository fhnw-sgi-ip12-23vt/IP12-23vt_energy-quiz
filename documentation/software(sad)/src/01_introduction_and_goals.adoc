...
https://fhnw-projecttrack.atlassian.net/wiki/spaces/IP1223vt5/pages/63997213/Requirements[Anforderungsdokument]
...
Die https://fhnw-projecttrack.atlassian.net/wiki/spaces/IP1223vt5/pages/63997213/Requirements[hier] definierten Funktionalitäten müssen in der Endversion des Systems vorhanden sein. 
| *Nachhaltigkeit:* | 
...
| Primeo | Wolgang Szabbó, W.szabo@primeo-energie.ch | Möchte ein Produkt für ihre Austellung. https://fhnw-projecttrack.atlassian.net/wiki/spaces/IP1223vt/pages/27132505/IP12+-+Technische+Rahmenbedingungen[Anforderungen],  
...
| FHNW | Samuel Fricker, samuel.fricker@fhnw.ch | Die FHNW gibt Anforderungen gegenüber der Architektur, welche eingehalten werden müssen. https://fhnw-projecttrack.atlassian.net/wiki/spaces/IP1223vt/pages/27132505/IP12+-+Technische+Rahmenbedingungen[Anforderungen]
...
Eine detailiertere Übersicht der Stakeholder kann https://fhnw-projecttrack.atlassian.net/wiki/spaces/IP1223vt5/pages/63997278/Stakeholder+Management#Produkt-Stakeholder[hier] gefunden werden.
