package energiequiz.components.base;
...
public abstract class Component {
   ...
   * An {@link InterruptedException} will be caught and ignored
   * while setting the interrupt flag again.
   *
