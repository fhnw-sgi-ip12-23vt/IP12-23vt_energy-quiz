...
import energiequiz.components.base.DigitalSensor;
...
public class SimpleButton extends DigitalSensor {
   ...
   *
   * <p>For a not-inverted button this means: if the button is pressed, then full voltage is present
   ...
   *
   * <p>For a not-inverted button this means: if the button is depressed, then no voltage is present
   ...
   *
   * <p>This event gets triggered whenever the button is pressed.
   ...
   *
   * <p>This event gets triggered whenever the button is no longer pressed.
   * Only a single event handler can be registered at once.
   *
   * @param task Event handler to call or null to disable
   */
